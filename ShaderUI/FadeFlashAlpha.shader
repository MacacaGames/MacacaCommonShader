	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 appendResult17 = (float4(1.0 , 1.0 , 1.0 , tex2D( _FlashGradient, uv_FlashGradient7 ).r));
...
/*ASEBEGIN
Version=18921
2359;197;1339;660;1016.687;-157.8893;1;True;True
...
ASEEND*/
//CHKSM=9C68B54505B634613C0B9D0B9EEAE68B94B77EA1